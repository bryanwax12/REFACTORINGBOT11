...
async def create_template(
    ...
    try:
        ...
        template_dict = {
            ...
            'from_street1': order_data.get('from_street', ''),
            'from_street2': order_data.get('from_street2', ''),
            ...
            'to_street1': order_data.get('to_street', ''),
            'to_street2': order_data.get('to_street2', ''),
