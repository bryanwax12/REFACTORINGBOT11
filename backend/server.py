        ...
        label_request = {
            ...
            'shipment': {
                'ship_to': {
                    ...
                    'phone': order['address_to'].get('phone') or '+15551234567',  # Default phone if empty or None
                ...
                'ship_from': {
                    ...
                    'phone': order['address_from'].get('phone') or '+15551234567',  # Default phone if empty or None
